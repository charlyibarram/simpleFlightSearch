...
import com.united.services.flightbooking.booking.model.FlightBookingModel;
import com.united.services.flightbooking.booking.model.FlightBookingSummaryModel;
import com.united.services.flightbooking.booking.model.converter.ToFlightBookingModelConverter;
...
public class BookingController {
	...
	public @ResponseBody FlightBookingModel getBookingById(@PathVariable String bookingId) {
		...
		logger.info("Buscando booking by id ... " + bookingId);
	...
	public @ResponseBody List<FlightBookingSummaryModel> getBookings(
		...
		logger.info("Buscando booking by passengerId ... " + passengerId);
	...
	private List<FlightBookingSummaryModel> getBookingsByPassengerId(String passengerId) {
		...
		logger.info("Buscando booking by idPasagero ... " + passengerId);
